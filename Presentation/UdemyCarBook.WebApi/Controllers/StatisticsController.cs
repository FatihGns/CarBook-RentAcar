...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        [HttpGet("GetCarCountByTransmissonIsAuto")]
        public async Task<IActionResult> GetCarCountByTransmissonIsAuto()
        {
            var values = await _mediator.Send(new GetCarCountByTransmissonIsAutoQuery());
            return Ok(values);
        }
